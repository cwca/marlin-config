...
#define STRING_CONFIG_H_AUTHOR "(Chris Walsh, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 4.2.7 + CR-Touch, v2.1, 2023-04-26"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.0, -40.0, 0 }
