...
#define STRING_CONFIG_H_AUTHOR "(Chris Walsh, Ender-3 DualZ SpritePro CRTouch V427)"
...
#define CUSTOM_MACHINE_NAME "Ender-3 SpriteProTouchDZ v2.1bf (4.2.7)"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
  #if ENABLED(PID_PARAMS_PER_HOTEND) // TODO check this
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2, 80.1, 400.7, 424.9 }
